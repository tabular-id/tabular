...
impl DeviceUiMetrics {
    ...
    pub fn touch_tablet(width: f32, height: f32) -> Self {
        Self {
            ...
            screen_width: width,
            screen_height: height,
            min_touch_size: egui::vec2(44.0, 40.0),
            button_padding: egui::vec2(16.0, 10.0),
            font_body_size: 15.0,
            font_monospace_size: 14.0,
            font_heading_size: 20.0,
            table_row_height: 38.0,
            sidebar_item_height: 38.0,
            tab_button_height: 44.0,
            scrollbar_width: 12.0,
            panel_margin: egui::Margin::same(10),
        }
    }
