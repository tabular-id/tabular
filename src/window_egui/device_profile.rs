...
impl DeviceUiMetrics {
    ...
    pub fn touch_tablet(width: f32, height: f32) -> Self {
        Self {
            ...
            screen_width: width,
            screen_height: height,
            min_touch_size: egui::vec2(48.0, 46.0),
            button_padding: egui::vec2(18.0, 12.0),
            font_body_size: 17.0,
            font_monospace_size: 15.5,
            font_heading_size: 22.0,
            table_row_height: 46.0,
            sidebar_item_height: 44.0,
            tab_button_height: 50.0,
            scrollbar_width: 16.0,
            panel_margin: egui::Margin::same(12),
        }
    }
